...
class KuhnPart1(Scene):
    def construct(self):
        ...
        self.play(AnimationGroup(FadeOut(kuhnPoker), AnimationGroup(FadeIn(back1, back2, back3), FadeIn(player_text, opponent_text)), lag_ratio=0.7))
        ...
        self.wait(1)
        self.play(Write(winner_text), group.animate.shift(0.2 * UP), opponent_text.animate.set_opacity(0.4), queen.animate.set_opacity(0.4))
        # self.wait(1)
...
class KuhnPart2(MovingCameraScene):
    def construct(self):
        ...
        self.play(self.camera.frame.animate.move_to(qkline.get_center()).set_width(13), FadeIn(qkline, you, opponent, unknown_2, king))
        self.wait(0.5)
        ...
        self.play(AnimationGroup(Create(call_line), Write(call), lag_ratio=0.5, run_time=1), 
        ...
        self.play(AnimationGroup(Create(call2_line), Write(call2), lag_ratio=0.5, run_time=1), 
                  AnimationGroup(Create(fold2_line), Write(fold2), lag_ratio=0.5, run_time=1),
        )
        self.wait(0.5)
        
        ellipse1 = Ellipse(width=check.width + 0.4, height=check.height + 0.4).move_to(check.get_center())
        ellipse2 = Ellipse(width=bet.width + 0.4, height=bet.height + 0.4).move_to(bet.get_center())
        ellipse3 = Ellipse(width=call2.width + 0.4, height=call2.height + 0.4).move_to(call2.get_center())
        ellipse4 = Ellipse(width=fold2.width + 0.4, height=fold2.height + 0.4).move_to(fold2.get_center())

        king_group = VGroup(check, check_line, bet, bet_line, call, call_line, check2, check2_line, bet2, bet2_line, call2, call2_line, fold, fold_line, fold2, fold2_line, qkline, ellipse1, ellipse2, ellipse3, ellipse4)
        ...
        FadeIn(ace_group, queen_group, ace_card, queen_card, unknown_ace, unknown_queen, unknown_king, ellipse1, ellipse2, ellipse3, ellipse4), run_time=3
        )
        self.wait(2)
...
class KuhnPart3(MovingCameraScene):
    def construct(self):
        ...
        check = Tex("Check", color=WHITE, font_size=34).move_to(1.5*LEFT +1.2 * DOWN)
        bet = Tex("Bet", color=WHITE, font_size=34).move_to(1.5*RIGHT + 1.2 * DOWN)
        check_line = Line(queen.get_center() + 0.7 * DOWN, check.get_center(), color=WHITE, buff=0.5)
        bet_line = Line(queen.get_center() + 0.7 * DOWN, bet.get_center(), color=WHITE, buff=0.5)
        self.play(AnimationGroup(Create(check_line), Write(check), lag_ratio=0.5, run_time=1), AnimationGroup(Create(bet_line), Write(bet), lag_ratio=0.5, run_time=1))
        self.wait(2)
        ...
        self.play(VGroup(check_line, check).animate.set_opacity(0.3), queen.animate.set_fill_opacity(0.3), 
        ...
        self.wait(0.5)
        self.play(AnimationGroup(Create(call_line), Write(call), lag_ratio=0.5, run_time=1), AnimationGroup(Create(fold_line), Write(fold), lag_ratio=0.5, run_time=1))
        self.wait(1)
        ...
        opponent = Text("OPPONENT", color=WHITE, font_size=34).move_to(king.get_center() + 2.5*LEFT)
        ...
        self.add(unknown_2)
        self.wait(1)
        self.play(self.camera.frame.animate.move_to(qkline.get_center()).set_width(13), FadeIn(qkline, you, opponent))
        ...
        self.play(VGroup(call_line, call, new_left_fifty, lose_1).animate.set_opacity(0.3), 
...
class RegretMatching(Scene):
    def construct(self):
        ...
        regret_matching = Tex(r"$\sigma_{i}^{T+1}(I, a) = \begin{cases} \frac{R_i^{T, +}(I,a)}{\sum_{a \in A(I)} R_i^{T, +} (I,a) } & \sum_{a \in A(I)} R_i^{T, +} (I,a) > 0\\ \frac{1}{|A(I)|} & \text{otherwise}\end{cases}$")
